    ...
    return (
      <Card className="bg-transparent border-none">
        <CardHeader>
          ...
          <CardDescription>
            Choose at least one gig in the Gigs tab to view assigned department
            contacts.
          </CardDescription>
        </CardHeader>
      </Card>
    ...
    <div className="space-y-6 rounded-2xl bg-[#F8F8F8] p-3">
      {selectedGigs.map((gig) => {
        ...
        const selectedIds = new Set(
          shortlistedOrConfirmed.map((person) => person.id),
        );
        ...
        const filteredGroups = contactGroups
          .map((group) => ({
            ...
            entries: group.entries.filter((entry) =>
              selectedIds.has(entry.person.id),
            ),
          }))
            ...
            <div className="flex flex-col gap-3">
                      ...
                      {gig.dateWindows.map((window, windowIndex) => {
                        ...
                        return (
                          <div
                            ...
                            className="flex items-center gap-3  px-3 py-1 text-sm text-[#444444]"
                          >
              ...
              {filteredGroups.length === 0 ? (
                <p className="px-2 text-sm text-gray-500">
                  No shortlisted or confirmed applicants yet.
                </p>
              ) : (
                      ...
                      <div className="min-w-[1057px]">
                        ...
                        {group.entries.map((entry, index) => (
                          <div
                            ...
                            className="flex h-[41px] gap-px bg-white"
                          >
