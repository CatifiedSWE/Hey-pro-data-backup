              ...
              <div className="flex flex-col gap-6 lg:flex-row">
                <div className="flex-1 w-full">
                  <div className="flex items-center gap-4">
                    ...
                    />
                    <div>
                      <p className="text-[12px] font-[400] text-slate-900">
                        {gig.postedBy.name}
                      </p>
                      <p className="text-[9px] font-[400] text-[#444444]">
                        Posted on {gig.postedOn}
                      </p>
                    </div>
                  </div>
                  <h3 className="mt-4 text-[18px] font-[400] text-[#444444]">
                    {gig.title}
                  </h3>
                  <p className="mt-3 text-[14px] font-[400] text-[#444444]">
                    {gig.description}
                  </p>
                ...
                <div
                  className="hidden lg:block lg:w-px max-h-[271px] mr-4 lg:bg-slate-200"
                  aria-hidden
                />
                ...
                <div className="flex w-full flex-wrap gap-4 sm:flex-col lg:w-[260px]">
                  <div className="flex-col hidden sm:flex items-start gap-1 text-right lg:items-end">
                    <span className="text-xs font-[400]  tracking-wide text-[#FA6E80]">
                      Apply before {gig.applyBefore}
                    </span>
                  </div>
                  <div>
                    <p className="text-[14px] font-[400] text-[#444444] hidden sm:flex gap-1.5">
                      <span className="text-[14px] font-[600]">AED </span>{" "}
                      {gig.budgetLabel}
                    </p>
                      ...
                      <div className=" text-sm font-[400] text-[#444444]">
                        {gig.dateWindows.map((window, windowIndex) => (
                          <p key={`${gig.id}-window-${windowIndex}`}>
                            <span className="font-[400] text-[14.19px] text-[#444444]">
                              {window.label}
                            </span>
                            <span className="text-[#444444] font-[400] text-sm">
                              {" "}
                              | {window.range}
                            </span>
                          </p>
                  ...
                  <div className="flex items-start gap-3 text-sm text-slate-700">
                    ...
                    <p className="font-[400] text-[12px] text-[#444444]">
                      {gig.location}
                    </p>
                  </div>
