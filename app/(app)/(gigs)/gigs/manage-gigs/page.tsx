      ...
      <div className="flex flex-col sm:flex-row items-start justify-start gap-y-2  sm:justify-between">
        ...
        <div className="flex flex-row gap-3.5 justify-center items-center">
          <Button
            asChild
            variant={"default"}
            className="h-11 rounded-2xl px-5 flex items-center bg-transparent text-[#31A7AC] border border-[#31A7AC] gap-2"
          >
            <Link
              href="/gigs/manage-gigs/add-new"
      ...
      >
        ...
        <TabsContent value="gigs" className="bg-[#F8F8F8] -mt-10">
          <GigList
            ...
            onToggleGig={handleToggleGig}
          />
        </TabsContent>

        <TabsContent
          value="application"
          className="bg-[#F8F8F8] -mt-10 sm:w-[1060px]"
        >
          <ApplicationTab
            selectedGigIds={selectedGigIds}
