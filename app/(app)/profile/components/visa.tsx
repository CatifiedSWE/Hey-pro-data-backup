...
export default function VisaSection({ onUpdate }: VisaSectionProps) {
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="w-full max-w-[430px] h-[500px]  overflow-x-auto border-none bg-transparent p-0">
                <form onSubmit={handleSubmit}>
                    <div className="mx-auto flex h-full max-h-[613px] w-full max-w-[393px] flex-col rounded-t-[20px] bg-white px-5 pb-6 pt-[25px] shadow-[0_8px_18px_rgba(0,0,0,0.1)]">
